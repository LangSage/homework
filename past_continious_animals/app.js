...
const SAVE_KEY = "pastContiniousAnimalsProgress";

const steps = [
  {
    type: "intro",
    title: "The Lost Dog",
    body: "Animals, pets, street animals, safe help, and Past Continuous. Answer one step, then move on."
  },
  {
    type: "explain",
  ...
  },
  {
    ...
    prompt: "I ___ walking my dog yesterday evening.",
    options: ["was", "were", "am"],
    answer: "was"
  },
  {
    ...
    task: 2,
    title: "Choose was or were",
    prompt: "They ___ looking for their cat.",
  ...
  },
  {
    ...
    task: 3,
    title: "Choose was or were",
    prompt: "The dog ___ barking loudly.",
  ...
  },
  {
    ...
    task: 4,
    title: "Negative",
    prompt: "They ___ helping the stray dog.",
  ...
  },
  {
    ...
    prompt: "the dog / bark?",
    answer: "Was the dog barking?"
  },
  {
    type: "input",
    task: 10,
    title: "Make a Question",
    prompt: "they / look / for the puppy?",
    answer: "Were they looking for the puppy?"
  },
  {
    type: "reading",
    title: "Why People Keep Pets",
    body: "Many people keep pets because animals make life warmer. A dog can be a friend and a reason to walk every day. A cat can make a flat feel comfortable. Pets can help people feel less lonely. But pets are not toys. They need food, water, time, care, and money."
  },
  {
    type: "choice",
    task: 11,
    title: "Reading",
    prompt: "Why do many people keep pets?",
    options: ["Because pets make life warmer", "Because pets are machines", "Because pets need no care"],
    answer: "Because pets make life warmer"
  },
  {
    type: "choice",
    task: 12,
    title: "Reading",
    prompt: "What does a pet need?",
    options: ["Food, water, time, care, and money", "Only a toy", "Nothing"],
    answer: "Food, water, time, care, and money"
  },
  {
    type: "reading",
    title: "Story: The Lost Dog",
    body: "Yesterday evening, Alina was walking home from college. It was cold and getting dark. She saw a small dog near the bus stop. The dog was standing alone and shaking. It was wearing a red collar, but there was no phone number. People were walking past it. Alina called Denis, posted a photo in a local chat, and later the owner found the dog."
  },
  {
    type: "choice",
    task: 13,
    title: "Story",
    prompt: "Where was Alina walking?",
    options: ["Home from college", "To the zoo", "Inside a shelter"],
    answer: "Home from college"
  },
  {
    type: "choice",
    task: 14,
    title: "Story",
    prompt: "What was the dog wearing?",
    options: ["A red collar", "A blue leash", "A coat"],
    answer: "A red collar"
  },
  {
    type: "choice",
    task: 15,
    title: "True or False",
    prompt: "People were walking past the dog.",
    options: ["True", "False"],
    answer: "True"
  },
  {
    ...
    task: 16,
    title: "Complete",
    prompt: "Alina ___ walking home from college.",
    answer: "was"
  },
  {
    type: "input",
    task: 17,
    title: "Complete",
    prompt: "People ___ walking past the dog.",
    answer: "were"
  },
  {
    type: "reading",
    title: "Street Animals",
    body: "Street animals often look for food, sleep in cold places, and stay away from cars. People can help by giving water, posting photos online, calling a shelter, or asking adults. Be careful: a frightened animal can bite or scratch."
  },
  {
    type: "choice",
    task: 18,
    title: "Safe or Dangerous?",
    prompt: "A boy is running quickly to a frightened dog.",
  ...
  },
  {
    ...
    task: 19,
    title: "Safe or Dangerous?",
    prompt: "A girl is calling a shelter.",
    options: ["Safe", "Dangerous"],
    answer: "Safe"
  },
  {
    ...
    task: 20,
    title: "Safe or Dangerous?",
    prompt: "A child is touching an angry dog.",
    options: ["Safe", "Dangerous"],
    answer: "Dangerous"
  },
  {
    ...
    body: "Some animals work with people. Police dogs find dangerous things. Guide dogs help blind people. Rescue dogs look for people after accidents. Horses can help in villages, sport, tourism, and therapy."
  },
  {
    type: "choice",
    task: 21,
    title: "Working Animals",
    prompt: "What does a guide dog do?",
    options: ["Helps a blind person", "Catches mice", "Orders tea"],
    answer: "Helps a blind person"
  },
  {
    type: "input",
    task: 22,
    title: "Working Animals",
    prompt: "The rescue dog ___ searching for people.",
    answer: "was"
  },
  {
    type: "reading",
    title: "Funny Animal Videos",
    body: "Animal videos can be funny when the animal is safe and happy. A video is wrong if the animal is scared, angry, or in danger. People should not make animals uncomfortable for likes."
  },
  {
    type: "choice",
    task: 23,
    title: "Funny or Wrong?",
    prompt: "A dog is playing with a ball in the garden.",
    options: ["Funny and safe", "Wrong"],
    answer: "Funny and safe"
  },
  {
    type: "choice",
    task: 24,
    title: "Funny or Wrong?",
    prompt: "A man is scaring a kitten for a video.",
    options: ["Funny and safe", "Wrong"],
    answer: "Wrong"
  },
  {
    type: "reading",
    title: "Wild Animals Near People",
    body: "Wild animals sometimes come close to cities because they are looking for food. They are not pets. Do not feed, touch, or take them home. If a wild animal is dangerous or injured, call special services."
  },
  {
    type: "choice",
    task: 25,
    title: "Wild Animals",
    prompt: "Should people feed wild animals?",
    options: ["No", "Yes"],
    answer: "No"
  },
  {
    ...
    prompt: "At 6 a.m., a fox was near the bins. It was ___ for food.",
    answer: "looking"
  },
  {
    type: "textarea",
    task: 27,
    title: "Problem Case",
    prompt: "A dog was sitting in a hot car and breathing fast. What should people do?",
    minWords: 6
  },
  {
    type: "textarea",
    task: 28,
    title: "Short Answer",
    prompt: "You saw a stray cat near the road. Write 2 safe actions.",
    minWords: 6
  },
  {
    type: "textarea",
    task: 29,
    title: "Mini Story",
    prompt: "Write 4 sentences about an animal. Use was/were + verb-ing.",
    minWords: 14
  },
  {
    type: "input",
    task: 30,
    title: "Final Grammar",
    prompt: "She ___ feeding the rabbit.",
    answer: "was"
  },
  {
    type: "input",
    task: 31,
    title: "Final Grammar",
    prompt: "We ___ watching a film about animals.",
    answer: "were"
  },
  {
    type: "input",
    task: 32,
    title: "Final Grammar",
    prompt: "The rabbit ___ hiding under the table.",
    answer: "was"
  },
  {
    type: "textarea",
    task: 33,
    title: "Final Writing",
    prompt: "Write 5 sentences about yesterday evening. Use was, were, wasn't or weren't.",
    minWords: 18
  },
  {
    type: "finish",
    title: "Finish",
    body: "Check your name, then send your results."
  }
];
...
function render() {
  ...
  nextBtn.textContent = step.type === "finish" ? "Send results" : step.type === "explain" || step.type === "reading" || step.type === "intro" ? "Continue" : "Check & continue";
  ...
  if (step.type === "intro" || step.type === "reading") {
    ...
    card.innerHTML = `
      <h2>${escapeHtml(step.title)}</h2>
      <p class="lead">${escapeHtml(step.prompt)}</p>
    ...
    card.innerHTML = `
      <h2>${escapeHtml(step.title)}</h2>
      <label class="inline-field">${escapeHtml(step.prompt)}<input id="answerField" value="${escapeHtml(state.answers[step.task] || "")}" autocomplete="off"></label>
    `;
...
function validateCurrent() {
  ...
  if (step.answer) {
    ...
    if (!ok) {
      message.textContent = "Check the rule and try again.";
      return false;
    }
  }
...
function buildResults() {
  ...
  const correct = checkedSteps.filter((step) => normalize(state.answers[step.task]) === normalize(step.answer)).length;
  const openDone = taskSteps.filter((step) => !step.answer && words(state.answers[step.task]) >= (step.minWords || 1)).length;
  ...
  return {
    ...
    completedTasks: taskSteps.filter((step) => String(state.answers[step.task] || "").trim()).length,
    totalTasks: taskSteps.length,
    tasks: taskSteps.map((step) => ({
      task: step.task,
      answered: String(state.answers[step.task] || "").trim() ? 1 : 0,
      checked: step.answer ? 1 : 0,
      correct: step.answer ? (normalize(state.answers[step.task]) === normalize(step.answer) ? 1 : 0) : (words(state.answers[step.task]) >= (step.minWords || 1) ? 1 : 0)
    })),
...
function wrapVisibleWords() {
  ...
  const walker = document.createTreeWalker(card, NodeFilter.SHOW_TEXT, {
    acceptNode(node) {
      ...
      if (!parent || parent.closest("input, textarea, button")) return NodeFilter.FILTER_REJECT;
